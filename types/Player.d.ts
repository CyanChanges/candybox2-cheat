...
export default class Player extends QuestEntity{
    // The game
    private game: Game;
    ...
    public beginBerserk(duration: number): boolean{
        // Call the mother export default class method
    ...
    public checkCollision(pos: Pos = new Pos(0, 0)): boolean{
        // If our mother export default class detects a collision, we return true
    ...
    public shouldDie(): boolean{
        // We use the method of our mother export default class PLUS we're also dead if out of area
    ...
    public stopBerserk(): void{
        // Mother export default class method
        super.stopBerserk();
