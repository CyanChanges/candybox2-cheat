...
export default class DeveloperMagicBall extends Fireball{
    // The time to live
    ...
    constructor(quest: Quest, pos: Pos, naming: Naming, color: Color, size: Pos, damage: number, questEntityDamageReason: QuestEntityDamageReason, timeToLive: number){
        // Call the mother export default class constructor
    ...
    public update(): void{
        ...
        // Call the mother export default class update method
        super.update();
    }
